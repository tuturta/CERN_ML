...
reduce_lr = torch.optim.lr_scheduler.ReduceLROnPlateau(optimizer = optimizer, factor=0.5, patience=3, min_lr=1e-7, verbose = True)
...
dataset   = Circles_Dataset(root='Data')
...
print('size_dataloader = ', len(train_loader))
